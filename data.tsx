...
export const dataPortfolio = [
  {
    ...
    image: "/game-hub1.png",
    description:
      "Primer gran proyecto personal, donde utilize JavaScript, React , Vite, Node, Express y Mocha chai ente otros... la funcion de la app es rankear de manera personal los videojuegos",
    urlGithub: "https://github.com/AdrianGonzalo/game-hub",
    urlDemo: "https://main--gamehub-players.netlify.app",
  },
  {
    id: 2,
    title: "RPG-Player-Maker",
    image: "/RPG.png",
    description:
      "Proyecto actual, que consta de un creador de personajes de rol, debido al movimiento de datos y interaccion entre ellos, no esta acabado todavia",
    urlGithub: "https://github.com/AdrianGonzalo/RPG-PLayerMaker",
    urlDemo: "https://github.com/AdrianGonzalo/RPG-PLayerMaker",
  },
  {
    id: 3,
